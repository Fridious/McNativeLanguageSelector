...
final String RESOURCE_ID = "415e443a-e655-11eb-8ba0-0242ac180002"

final String BRANCH_DEVELOPMENT = "development"
final String BRANCH_BETA = "beta"
final String BRANCH_MASTER = "master"

String PROJECT_NAME = "McNativeLanguageSelector"
...
def MIRROR_SERVER_PUBLISHING = [
        "target/McNativeLanguageSelector-%version%.jar": "default",
]
